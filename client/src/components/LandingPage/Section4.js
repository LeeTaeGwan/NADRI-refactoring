...
const Section4_Left_Img = styled.div`
width: 40%;
height: 80%;
transition: all 1s;
...
const Section4_Right_Desc = styled.div`
width: 50%;
height: auto;
display: flex;
flex-direction: column;
...
export default function Section4({innerHeight}) {
  ...
  return (
    <Section innerHeight={innerHeight}>
        <Section4_Left_Img ref={target} isValid={isValid}>
